package ucai.cn.day_filicenter.views;
...
import ucai.cn.day_filicenter.utils.ConvertUtils;
...
public class CatChildFilterButton extends Button {
    ...
    private void initPopupWindow() {
        ...
        mPopupWindow.setHeight(LinearLayout.LayoutParams.WRAP_CONTENT);
            ...
            mPopupWindow.setHeight(ConvertUtils.px2dp(mContext, 600));
        }
